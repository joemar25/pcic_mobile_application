...
import 'ppir_copy_model.dart';
export 'ppir_copy_model.dart';

class PpirCopyWidget extends StatefulWidget {
  const PpirCopyWidget({
    super.key,
  ...
  @override
  State<PpirCopyWidget> createState() => _PpirCopyWidgetState();
}

class _PpirCopyWidgetState extends State<PpirCopyWidget> {
  late PpirCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PpirCopyModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<PpirFormsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PpirFormsRow> ppirCopyPpirFormsRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final ppirCopyPpirFormsRow = ppirCopyPpirFormsRowList.isNotEmpty
            ? ppirCopyPpirFormsRowList.first
            : null;
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                ...
                                                text: ppirCopyPpirFormsRow
                                                    ?.trackLastCoord,
                                              ),
                                              focusNode: _model
                                                  .trackCoordinatesFocusNode,
                                              autofocus: false,
                                              readOnly: true,
                                              obscureText: false,
                                                ...
                                                if (_model.isRice == true)
                                                  FutureBuilder<List<SeedsRow>>(
                                                    ...
                                                    builder:
                                                      ...
                                                      List<SeedsRow>
                                                          riceDropdownASeedsRowList =
                                                          snapshot.data!;

                                                      return FlutterFlowDropDown<
                                                          String>(
                                                        controller: _model
                                                                .riceDropdownAValueController ??=
                                                            FormFieldController<
                                                                String>(
                                                          _model.riceDropdownAValue ??=
                                                              ppirCopyPpirFormsRow
                                                                  ?.ppirVariety,
                                                        ),
                                                        options: List<
                                                ...
                                                if (_model.isRice == false)
                                                  FutureBuilder<List<SeedsRow>>(
                                                    ...
                                                    builder:
                                                      ...
                                                      List<SeedsRow>
                                                          cornDropdownBSeedsRowList =
                                                          snapshot.data!;

                                                      return FlutterFlowDropDown<
                                                          String>(
                                                        controller: _model
                                                                .cornDropdownBValueController ??=
                                                            FormFieldController<
                                                                String>(
                                                          _model.cornDropdownBValue ??=
                                                              ppirCopyPpirFormsRow
                                                                  ?.ppirVariety,
                                                        ),
                                                        options: List<
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '9dqjnq6f' /* Please select... */,
                                                        ),
                                                        searchHintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '6jp5h0rv' /* Search for an item... */,
                                                        ),
                                                        icon: Icon(
                                                          Icons
                                                              .keyboard_arrow_down_rounded,
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '750t3ie5' /* Actual Date of Planting (DS) */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'ay9zaj06' /* Actual Date of Planting (TS) */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
