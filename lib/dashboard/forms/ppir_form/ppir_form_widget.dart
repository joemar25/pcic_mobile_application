...
class _PpirFormWidgetState extends State<PpirFormWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().update(() {});
      _model.gpx = await SQLiteManager.instance.sELECTPPIRFORMSGpx(
        taskId: widget.taskId,
      );
      if (_model.gpx?.first.gpx == 'null') {
        await showDialog(
          ...
          builder: (dialogContext) {
            return Dialog(
              ...
              child: GestureDetector(
                ...
                child: const NoGpxDialogWidget(),
              ),
            );
          },
        ).then((value) => safeSetState(() => _model.confirmR = value));
          ...
          context.pushNamed(
            ...
            queryParameters: {
              ...
              'assignmentId': serializeParam(
                ppirFormSelectPpirFormsRowList.first.ppirAssignmentid,
                ParamType.String,
              ),
            }.withoutNulls,
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (context) => FutureBuilder<List<SelectPpirFormsRow>>(
                                                        ...
                                                        FutureBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return FlutterFlowDropDown<
                                                              ...
                                                              options: riceDropdownSELECTRiceSEEDSRowList
                                                                  .map((e) =>
                                                                      e.seed)
                                                                  .withoutNulls
                                                                  .toList(),
                                                        ...
                                                        FutureBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return FlutterFlowDropDown<
                                                              ...
                                                              options: cornDropdownSELECTCornSEEDSRowList
                                                                  .map((e) =>
                                                                      e.seed)
                                                                  .withoutNulls
                                                                  .toList(),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              height: MediaQuery.sizeOf(context).height * 1.0,
                                                                              taskId: widget.taskId,
                                                                              signatureBlob: ppirFormSelectPpirFormsRowList.first.ppirSigInsured,
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              height: MediaQuery.sizeOf(context).height * 1.0,
                                                                              taskId: widget.taskId,
                                                                              signatureBlob: ppirFormSelectPpirFormsRowList.first.ppirSigIuia,
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      ),
