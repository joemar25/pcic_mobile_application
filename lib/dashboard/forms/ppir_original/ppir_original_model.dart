...
import 'ppir_original_widget.dart' show PpirOriginalWidget;
import 'package:flutter/material.dart';

class PpirOriginalModel extends FlutterFlowModel<PpirOriginalWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in ppirOriginal widget.
