...
import 'all_tasks_copy_model.dart';
export 'all_tasks_copy_model.dart';

class AllTasksCopyWidget extends StatefulWidget {
  const AllTasksCopyWidget({
    super.key,
    String? taskStatus,
  ...
  @override
  State<AllTasksCopyWidget> createState() => _AllTasksCopyWidgetState();
}

class _AllTasksCopyWidgetState extends State<AllTasksCopyWidget> {
  late AllTasksCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTasksCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SELECTPPIRFormsByAssigneeAndTaskStatusRow>>(
      ...
      builder: (context, snapshot) {
        ...
        final allTasksCopySELECTPPIRFormsByAssigneeAndTaskStatusRowList =
            snapshot.data!;
                    ...
                    Flexible(
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: wrapWithModel(
                            model: _model.tasksRowModel,
                            updateCallback: () => safeSetState(() {}),
                            child: const TasksRowWidget(
                              farmerName: '1',
                              insuranceId: '1',
                              assignmentId: '1',
                            ),
