...
import 'all_tasks_original_model.dart';
export 'all_tasks_original_model.dart';

class AllTasksOriginalWidget extends StatefulWidget {
  const AllTasksOriginalWidget({
    super.key,
    String? taskStatus,
  ...
  @override
  State<AllTasksOriginalWidget> createState() => _AllTasksOriginalWidgetState();
}

class _AllTasksOriginalWidgetState extends State<AllTasksOriginalWidget> {
  late AllTasksOriginalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTasksOriginalModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SELECTPPIRFormsByAssigneeAndTaskStatusRow>>(
      ...
      builder: (context, snapshot) {
        ...
        final allTasksOriginalSELECTPPIRFormsByAssigneeAndTaskStatusRowList =
            snapshot.data!;
                            ...
                            onFieldSubmitted: (_) async {
                              ...
                              safeSetState(() {
                                _model.simpleSearchResults = TextSearch(
                                        allTasksOriginalSELECTPPIRFormsByAssigneeAndTaskStatusRowList
