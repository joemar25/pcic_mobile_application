...
import 'task_details_copyx_model.dart';
export 'task_details_copyx_model.dart';

class TaskDetailsCopyxWidget extends StatefulWidget {
  const TaskDetailsCopyxWidget({
    super.key,
  ...
  @override
  State<TaskDetailsCopyxWidget> createState() => _TaskDetailsCopyxWidgetState();
}

class _TaskDetailsCopyxWidgetState extends State<TaskDetailsCopyxWidget> {
  late TaskDetailsCopyxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskDetailsCopyxModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PpirFormsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        final taskDetailsCopyxPpirFormsRow =
            taskDetailsCopyxPpirFormsRowList.isNotEmpty
                ? taskDetailsCopyxPpirFormsRowList.first
                : null;
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '08kgdns5' /* Completed Task  Details */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyLarge
