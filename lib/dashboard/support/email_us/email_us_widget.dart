                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'kms1zdyl' /* Contact us through our email a... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'drvdqe2p' /* or feel free to give us a mess... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelLarge
                                    .override(
                              ...
                              children: [
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'j3nymxm8' /* Enter your personal informatio... */,
                                      ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'msi4fo1j' /* Choose the type of purpose */,
                                        ),
                                        icon: Icon(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            '1ovjjhqy' /* Input your message here... */,
                                          ),
