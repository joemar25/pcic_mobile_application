...
class _DashboardWidgetState extends State<DashboardWidget>
  ...
  void initState() {
    ...
    _model.mobileFindTasksInputFieldTextController ??= TextEditingController();
    _model.mobileFindTasksInputFieldFocusNode ??= FocusNode();
                                          ...
                                          child: Container(
                                            ...
                                            child: Visibility(
                                              ...
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .mobileFindTasksInputFieldTextController,
                                                  focusNode: _model
                                                      .mobileFindTasksInputFieldFocusNode,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelText:
                                                        FFLocalizations.of(
                                          ...
                                          Padding(
                                            ...
                                            child:
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<TasksRow>
                                                    taskMobileListFDTasksRowList =
                                                    snapshot.data!;

                                                if (taskMobileListFDTasksRowList
                                                    .isEmpty) {
                                                  return const Center(
                                                ...
                                                return ListView.builder(
                                                  ...
                                                  itemCount:
                                                      taskMobileListFDTasksRowList
                                                          .length,
                                                  itemBuilder: (context,
                                                      taskMobileListFDIndex) {
                                                    final taskMobileListFDTasksRow =
                                                        taskMobileListFDTasksRowList[
                                                            taskMobileListFDIndex];
                                                    return wrapWithModel(
                                                      model: _model.tasksModels1
                                                          .getModel(
                                                        taskMobileListFDTasksRow
                                                            .id,
                                                        taskMobileListFDIndex,
                                                      ),
                                                      updateCallback: () =>
                                                      ...
                                                      child: TasksWidget(
                                                        key: Key(
                                                          'Keymnz_${taskMobileListFDTasksRow.id}',
                                                        ),
                                                        task:
                                                            taskMobileListFDTasksRow
                                                                .id,
                                          ...
                                          Padding(
                                            ...
                                            child:
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                List<TasksRow>
                                                    taskMobileListOTasksRowList =
                                                    snapshot.data!;

                                                if (taskMobileListOTasksRowList
                                                    .isEmpty) {
                                                  return const Center(
                                                    child: EmptyListsWidget(
                                                      type: 'Ongoing Tasks',
                                                ...
                                                return ListView.builder(
                                                  ...
                                                  itemCount:
                                                      taskMobileListOTasksRowList
                                                          .length,
                                                  itemBuilder: (context,
                                                      taskMobileListOIndex) {
                                                    final taskMobileListOTasksRow =
                                                        taskMobileListOTasksRowList[
                                                            taskMobileListOIndex];
                                                    return wrapWithModel(
                                                      model: _model.tasksModels2
                                                          .getModel(
                                                        taskMobileListOTasksRow
                                                            .id,
                                                        taskMobileListOIndex,
                                                      ),
                                                      updateCallback: () =>
                                                      ...
                                                      child: TasksWidget(
                                                        key: Key(
                                                          'Keymz6_${taskMobileListOTasksRow.id}',
                                                        ),
                                                        task: dashboardUsersRow!
                                                            .id,
                                                        status:
                                                            taskMobileListOTasksRow
                                                                .status,
                                                ...
                                                return ListView.builder(
                                                  ...
                                                  itemBuilder: (context,
                                                    ...
                                                    return wrapWithModel(
                                                      ...
                                                      child: TasksWidget(
                                                        key: Key(
                                                          'Key00b_${taskMobileListOTasksRow.id}',
                                                        ),
                                                        task:
                                                            taskMobileListOTasksRow
                                                                .id,
