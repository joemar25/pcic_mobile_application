  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TasksRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TasksRow> syncKingTasksRowList = snapshot.data!;
                      ...
                      children: [
                        ...
                        if ((_model.isSync == true) ||
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                'Numebr of tasks synced : ${valueOrDefault<String>(
                              ...
                              Text(
                                'Numebr of tasks : ${valueOrDefault<String>(
                              ...
                              Row(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'yv1vln63' /* Tap the button to sync */,
                                      ),
                              ...
                              Row(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'hhy7zu7j' /* Tap the button to sync again */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
