  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> formSuccessUsersRowList = snapshot.data!;

        final formSuccessUsersRow = formSuccessUsersRowList.isNotEmpty
            ? formSuccessUsersRowList.first
            : null;
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'You completed the ${widget.assignmentId}.',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                fontFamily:
