...
import 'backup_login_model.dart';
...
class BackupLoginWidget extends StatefulWidget {
  ...
  @override
  State<BackupLoginWidget> createState() => _BackupLoginWidgetState();
}

class _BackupLoginWidgetState extends State<BackupLoginWidget>
    with TickerProviderStateMixin {
  late BackupLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BackupLoginModel());
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'atiwkpq2' /* Please sign in to continue */,
                                          ),
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '0owe4y3y' /* Enter your email address */,
                                                  ),
